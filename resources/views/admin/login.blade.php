...
<div class="container ">
    <div class="row">
        <div class="col-12 col-sm-5 offset-sm-3 text-center">
            ...
            <form action="/adminLogin" method="post" class="signup-content form" id="form" autocomplete="off">
                @csrf
...
<div id="id01" class="modal align-items-center">
    ...
    <form class="form-horizontal modal-content animate " method="post" action="/adminLogin">
        @csrf
